...
void loop() {
  ...
  // Send status report every 30 seconds to keep device online
  unsigned long now = millis();
  if (now - lastStatusReport >= 30000) { // 30 seconds
...
<parameter name="filePath">/Users/syedehsan/Development/syed/home-iot/esp8266-keepalive.cpp